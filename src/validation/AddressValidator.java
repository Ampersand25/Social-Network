...
public class AddressValidator implements IValidator<Address> {
    ...
    public void validate(@NotNull Address address) throws ValidationException {
        ...
        if(homeAddress == null) {
            ...
            err += "[!]Invalid home address (home address name is too short)!\n";
        }
        ...
        if(country == null) {
            ...
            err += "[!]Invalid country (country name is too short)!\n";
        }
        ...
        if(county == null) {
            ...
            err += "[!]Invalid county (county name is too short)!\n";
        }
        ...
        if(city == null) {
            ...
            err += "[!]Invalid city (city name is too short)!\n";
        }
